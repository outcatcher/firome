...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttonActivitySelect.setGeometry(QRect(460, 70, 170, 25))
        self.buttonBox = QDialogButtonBox(self.centralwidget)
        self.buttonBox.setObjectName(u"buttonBox")
        self.buttonBox.setGeometry(QRect(290, 350, 341, 32))
        ...
        self.precisionLabel.setGeometry(QRect(490, 138, 141, 20))
